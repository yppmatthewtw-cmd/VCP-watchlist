#!/usr/bin/env python3
"""Check R19's Yahoo-sourced 2026-09-14 closes against the official close.

R19 published 9/14 from Yahoo alone — the upstream snapshot repo had nothing
newer than a 9/14 mid-session quote. The 9/15 mid-session snapshot's
...
filled_94 = set(FILLED.get("2026-09-14", []))
...
json.dump(out, open("validate_r19_0914.json", "w"), ensure_ascii=False, indent=1)
print(f"R19 9/14 published vs official: n={out['n']} median |Δ|={out['median_pct']}% "
