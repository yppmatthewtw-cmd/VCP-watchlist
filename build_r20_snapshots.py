#!/usr/bin/env python3
"""R20 snapshot refresh: 2026-09-15 closes (Yahoo, cross-checked against the official series) for the whole universe, with
the classification fixes from the 2026-09-02 critical review.

Sources: cert7_2026-09-15.json (official series, 241 tickers) + the 9/15 HEAD (mid-session) snapshot for market cap / sector only
...
R24 -> R25, stage R17 -> R18, PB R17 -> R18. Old snapshots are kept untouched.
"""
...
def apply_official(r):
    ...
    for k in ("px_0904_intraday", "chg_0904_intraday"):
        r.pop(k, None)
    r["as_of"] = AS_OF if src == "series" else "2026-09-14"   # HEAD fallback = 9/14 close (mid-session 9/15 snapshot)
    r.pop("stale", None)
...
JOBS = [("scan_R24_2026-09-15.json", "scan_R25_2026-09-16.json", "vcp"),
        ("scan_stage_R17_2026-09-15.json", "scan_stage_R18_2026-09-16.json", "stage"),
        ("scan_PB-R17_2026-09-15.json", "scan_PB-R18_2026-09-16.json", "pb")]
