#!/usr/bin/env python3
"""R14 snapshot refresh: 2026-09-04 closes (Yahoo, cross-checked against the official series) for the whole universe, with
the classification fixes from the 2026-09-02 critical review.

Sources: cert7_2026-09-04.json (official series, 241 tickers) + the 9/4 HEAD (mid-session) snapshot for market cap / sector only
...
R18 -> R19, stage R11 -> R12, PB R11 -> R12. Old snapshots are kept untouched.
"""
...
def apply_official(r):
    ...
    for k in ("px_0904_intraday", "chg_0904_intraday"):
        r.pop(k, None)
    r["as_of"] = AS_OF if src == "series" else "2026-09-03"   # HEAD fallback = 9/3 close (mid-session 9/4 snapshot)
    r.pop("stale", None)
...
JOBS = [("scan_R18_2026-09-05.json", "scan_R19_2026-09-06.json", "vcp"),
        ("scan_stage_R11_2026-09-05.json", "scan_stage_R12_2026-09-06.json", "stage"),
        ("scan_PB-R11_2026-09-05.json", "scan_PB-R12_2026-09-06.json", "pb")]
