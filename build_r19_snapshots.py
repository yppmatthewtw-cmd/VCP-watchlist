#!/usr/bin/env python3
"""R19 snapshot refresh: 2026-09-14 closes (Yahoo, cross-checked against the official series) for the whole universe, with
the classification fixes from the 2026-09-02 critical review.

Sources: cert7_2026-09-14.json (official series, 241 tickers) + the 9/14 HEAD (mid-session) snapshot for market cap / sector only
...
R23 -> R24, stage R16 -> R17, PB R16 -> R17. Old snapshots are kept untouched.
"""
...
def apply_official(r):
    ...
    for k in ("px_0904_intraday", "chg_0904_intraday"):
        r.pop(k, None)
    r["as_of"] = AS_OF if src == "series" else "2026-09-11"   # HEAD fallback = 9/11 close (mid-session 9/14 snapshot)
    r.pop("stale", None)
...
JOBS = [("scan_R23_2026-09-12.json", "scan_R24_2026-09-15.json", "vcp"),
        ("scan_stage_R16_2026-09-12.json", "scan_stage_R17_2026-09-15.json", "stage"),
        ("scan_PB-R16_2026-09-12.json", "scan_PB-R17_2026-09-15.json", "pb")]
