...
NASDAQ += ['ANGO', 'ANIK', 'AXTI', 'BLFS', 'CLDX', 'CME', 'COIN', 'COST', 'CSX', 'DASH', 'EH', 'GILD', 'HOOD', 'HST', 'IOVA', 'ISRG', 'LQDA', 'LULU', 'MAR', 'MCHP', 'MRNA', 'NFLX', 'PCAR', 'REGN', 'ROST', 'RPRX', 'RVMD', 'SBUX', 'TXRH', 'UBSI', 'UFPT', 'URBN', 'VCYT', 'VRTX', 'VTRS', 'WDC']
NYSE += ['ABBV', 'AEO', 'AXP', 'BA', 'BAC', 'BIRK', 'BOOT', 'BX', 'CAH', 'CAT', 'CCJ', 'CVX', 'ENVA', 'ETR', 'FCX', 'FLR', 'GL', 'GLW', 'GAP', 'GS', 'GWW', 'H', 'HII', 'HLT', 'HMY', 'HUBB', 'ICE', 'JNJ', 'JPM', 'KKR', 'KO', 'LH', 'LLY', 'LMT', 'LUMN', 'MA', 'MET', 'MRK', 'NEE', 'NEM', 'NKE', 'NSC', 'OLN', 'OXY', 'PARR', 'PBF', 'PNC', 'RDW', 'RTX', 'SPOT', 'TGT', 'TJX', 'TPR', 'UNH', 'UNM', 'UNP', 'V', 'XOM', 'XPO']


# Pre-breakout universe (2026-08-23)
NASDAQ += ['ADPT', 'ALRS', 'AMAL', 'AMRX', 'ARWR', 'AXGN', 'BJRI', 'BRKR', 'CBIO', 'CCBG', 'CHRD', 'CORT', 'CYRX', 'DNTH', 'EBC', 'ELVN', 'FANG', 'FCFS', 'FTNT', 'GSAT', 'IBKR', 'JAZZ', 'KARO', 'KNSA', 'MBX', 'MEDP', 'MEOH', 'NEO', 'NWBI', 'PGC', 'PVLA', 'RAPP', 'RLAY', 'RRBI', 'RUSHB', 'SENEA', 'SLDE', 'SYRE', 'TGTX', 'TIGO', 'TRST', 'TRVI', 'VSAT', 'WSFS', 'ZD']
...
NYSE += ['DRH', 'HTO', 'LOB']   # listed on NYSE, not Nasdaq (review fix 2026-09-02)
