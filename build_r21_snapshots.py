#!/usr/bin/env python3
"""R21 snapshot refresh: 2026-09-16 closes (Yahoo, cross-checked against the official series) for the whole universe, with
the classification fixes from the 2026-09-02 critical review.

Sources: cert7_2026-09-16.json (official series, 241 tickers) + the 9/16 HEAD (mid-session) snapshot for market cap / sector only
...
R25 -> R26, stage R18 -> R19, PB R18 -> R19. Old snapshots are kept untouched.
"""
...
def apply_official(r):
    ...
    for k in ("px_0904_intraday", "chg_0904_intraday"):
        r.pop(k, None)
    r["as_of"] = AS_OF if src == "series" else "2026-09-15"   # HEAD fallback = 9/15 close (mid-session 9/16 snapshot)
    r.pop("stale", None)
...
JOBS = [("scan_R25_2026-09-16.json", "scan_R26_2026-09-17.json", "vcp"),
        ("scan_stage_R18_2026-09-16.json", "scan_stage_R19_2026-09-17.json", "stage"),
        ("scan_PB-R18_2026-09-16.json", "scan_PB-R19_2026-09-17.json", "pb")]
