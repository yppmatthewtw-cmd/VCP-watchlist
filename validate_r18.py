#!/usr/bin/env python3
"""Check R18's Yahoo-sourced 2026-09-11 closes against the official close.

R18 published 9/11 from Yahoo alone — the upstream snapshot repo had nothing
newer than a 9/11 mid-session quote. The 9/14 mid-session snapshot's
...
filled_94 = set(FILLED.get("2026-09-11", []))
...
json.dump(out, open("validate_r18_0911.json", "w"), ensure_ascii=False, indent=1)
print(f"R18 9/11 published vs official: n={out['n']} median |Δ|={out['median_pct']}% "
