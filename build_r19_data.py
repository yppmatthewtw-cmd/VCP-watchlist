#!/usr/bin/env python3
"""R19 data build: official 9/11 closes + Yahoo 9/14 closes + 7-item certainty + market-cap tiers (series5: official series through 2026-09-11 merged with Yahoo bars to 2026-09-14).
...
MY = set()
for f in ("scan_R23_2026-09-12.json", "scan_stage_R16_2026-09-12.json", "scan_PB-R16_2026-09-12.json"):
...
json.dump(cert, open("cert7_2026-09-14.json", "w"), ensure_ascii=False, indent=1)
# any NEW split-like cliff since the last build (9/11 -> 9/14)? (Yahoo-aligned series should show none)
for sym in have:
    fi, cs, vs, ff = SER[sym]
