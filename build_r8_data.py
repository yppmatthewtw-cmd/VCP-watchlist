#!/usr/bin/env python3
"""R8 data build: official 9/1 closes + 7-item certainty + market-cap tiers (series3 through 2026-09-01).

Sources: zyhe16/top-us-stock-tickers daily snapshots (rebuilt into series3.pkl)
...
d = pickle.load(open(f"{SCRATCH}/series3.pkl", "rb"))
...
pickle.dump({"cal": CAL, "series": SER}, open(f"{SCRATCH}/series3adj.pkl", "wb"))
...
MY = set()
for f in ("scan_R15_2026-09-01.json", "scan_stage_R8_2026-09-01.json", "scan_PB-R8_2026-09-01.json"):
...
json.dump(cert, open("cert7_2026-09-01.json", "w"), ensure_ascii=False, indent=1)
