#!/usr/bin/env python3
"""R16 data build: official 9/8 closes + Yahoo 9/9 closes + 7-item certainty + market-cap tiers (series5: official series through 2026-09-08 merged with Yahoo bars to 2026-09-09).
...
MY = set()
for f in ("scan_R20_2026-09-09.json", "scan_stage_R13_2026-09-09.json", "scan_PB-R13_2026-09-09.json"):
...
json.dump(cert, open("cert7_2026-09-09.json", "w"), ensure_ascii=False, indent=1)
# any NEW split-like cliff since the last build (9/8 -> 9/9)? (Yahoo-aligned series should show none)
for sym in have:
    fi, cs, vs, ff = SER[sym]
