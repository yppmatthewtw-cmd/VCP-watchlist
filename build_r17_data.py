#!/usr/bin/env python3
"""R17 data build: official 9/9 closes + Yahoo 9/10 closes + 7-item certainty + market-cap tiers (series5: official series through 2026-09-09 merged with Yahoo bars to 2026-09-10).
...
json.dump(cert, open("cert7_2026-09-10.json", "w"), ensure_ascii=False, indent=1)
# any NEW split-like cliff since the last build (9/9 -> 9/10)? (Yahoo-aligned series should show none)
for sym in have:
    fi, cs, vs, ff = SER[sym]
