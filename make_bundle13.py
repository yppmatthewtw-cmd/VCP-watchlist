...
def intra_cell(r):
    """R22: no mid-session column — the 9/17 close (Yahoo, cross-checked) is the newest data."""
    return ""
...
def main():
    ...
    ap.add_argument("--prev", default="scan_R26_2026-09-17.json,scan_stage_R19_2026-09-17.json,scan_PB-R19_2026-09-17.json",
                    help="previous release's three snapshot files (vcp,stage,pre) for the red diff")
    ap.add_argument("--prev-rank", default="rank_overlay_R21.json")
    ap.add_argument("--prev-cert", default="cert7_R21.json")
    ap.add_argument("--prev-cat", default="catalysts_R21.json")
    args = ap.parse_args()
...
<li><b>數據基準</b>：本版為<b>完整的 2026-09-17 收盤重掃</b> —— 官方日線序列已延伸至 9/15，
