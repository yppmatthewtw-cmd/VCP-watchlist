#!/usr/bin/env python3
"""R8 snapshot refresh: official 2026-09-01 closes for the whole universe, with
the classification fixes from the 2026-09-02 critical review.

Sources: cert7_2026-09-01.json (official series, 241 tickers) + the 9/1 HEAD
...
R15 -> R16, stage R8 -> R9, PB R8 -> R9. Old snapshots are kept untouched.
"""
...
d = pickle.load(open(f"{SCRATCH}/series3adj.pkl", "rb"))
...
JOBS = [("scan_R15_2026-09-01.json", "scan_R16_2026-09-02.json", "vcp"),
        ("scan_stage_R8_2026-09-01.json", "scan_stage_R9_2026-09-02.json", "stage"),
        ("scan_PB-R8_2026-09-01.json", "scan_PB-R9_2026-09-02.json", "pb")]
