#!/usr/bin/env python3
"""R16 snapshot refresh: 2026-09-09 closes (Yahoo, cross-checked against the official series) for the whole universe, with
the classification fixes from the 2026-09-02 critical review.

Sources: cert7_2026-09-09.json (official series, 241 tickers) + the 9/9 HEAD (mid-session) snapshot for market cap / sector only
...
R20 -> R21, stage R13 -> R14, PB R13 -> R14. Old snapshots are kept untouched.
"""
...
def apply_official(r):
    ...
    for k in ("px_0904_intraday", "chg_0904_intraday"):
        r.pop(k, None)
    r["as_of"] = AS_OF if src == "series" else "2026-09-08"   # HEAD fallback = 9/8 close (mid-session 9/9 snapshot)
    r.pop("stale", None)
...
JOBS = [("scan_R20_2026-09-09.json", "scan_R21_2026-09-10.json", "vcp"),
        ("scan_stage_R13_2026-09-09.json", "scan_stage_R14_2026-09-10.json", "stage"),
        ("scan_PB-R13_2026-09-09.json", "scan_PB-R14_2026-09-10.json", "pb")]
