#!/usr/bin/env python3
"""R14 data build: official 9/3 closes + Yahoo 9/4 closes + 7-item certainty + market-cap tiers (series5: official series through 2026-09-03 merged with Yahoo bars to 2026-09-04).
...
json.dump(cert, open("cert7_2026-09-04.json", "w"), ensure_ascii=False, indent=1)
# any NEW split-like cliff since the last build (9/3 -> 9/4)? (Yahoo-aligned series should show none)
for sym in have:
    fi, cs, vs, ff = SER[sym]
