#!/usr/bin/env python3
"""R21 data build: official 9/15 closes + Yahoo 9/16 closes + 7-item certainty + market-cap tiers (series5: official series through 2026-09-15 merged with Yahoo bars to 2026-09-16).
...
MY = set()
for f in ("scan_R25_2026-09-16.json", "scan_stage_R18_2026-09-16.json", "scan_PB-R18_2026-09-16.json"):
