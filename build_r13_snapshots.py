#!/usr/bin/env python3
"""R13 snapshot refresh: official 2026-09-03 closes for the whole universe, with
the classification fixes from the 2026-09-02 critical review.

Sources: cert7_2026-09-03.json (official series, 241 tickers) + the 9/4 HEAD
...
R17 -> R18, stage R10 -> R11, PB R10 -> R11. Old snapshots are kept untouched.
"""
...
def apply_official(r):
    ...
    if not r.get("name") and t == "GAP":
        r["name"] = "Gap Inc."
    for k in ("px_0903_intraday", "chg_0903_intraday"):
        r.pop(k, None)
    r["as_of"] = AS_OF
    r.pop("stale", None)
...
JOBS = [("scan_R17_2026-09-03.json", "scan_R18_2026-09-05.json", "vcp"),
        ("scan_stage_R10_2026-09-03.json", "scan_stage_R11_2026-09-05.json", "stage"),
        ("scan_PB-R10_2026-09-03.json", "scan_PB-R11_2026-09-05.json", "pb")]
