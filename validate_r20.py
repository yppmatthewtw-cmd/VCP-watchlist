#!/usr/bin/env python3
"""Check R20's Yahoo-sourced 2026-09-15 closes against the official close.

R20 published 9/15 from Yahoo alone — the upstream snapshot repo had nothing
...
filled_94 = set(FILLED.get("2026-09-15", []))
...
json.dump(out, open("validate_r20_0915.json", "w"), ensure_ascii=False, indent=1)
print(f"R20 9/15 published vs official: n={out['n']} median |Δ|={out['median_pct']}% "
