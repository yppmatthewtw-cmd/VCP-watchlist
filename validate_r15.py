#!/usr/bin/env python3
"""Check R15's Yahoo-sourced 2026-09-08 closes against the official close.

R15 published 9/8 from Yahoo alone — the upstream snapshot repo had nothing
newer than a 9/8 mid-session quote. The 9/9 mid-session snapshot's
...
filled_94 = set(FILLED.get("2026-09-08", []))
...
json.dump(out, open("validate_r15_0908.json", "w"), ensure_ascii=False, indent=1)
print(f"R15 9/8 published vs official: n={out['n']} median |Δ|={out['median_pct']}% "
