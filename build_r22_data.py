#!/usr/bin/env python3
"""R22 data build: official 9/15 closes + Yahoo 9/16 closes + 7-item certainty + market-cap tiers (series5: official series through 2026-09-15 merged with Yahoo bars to 2026-09-17).
...
MY = set()
for f in ("scan_R26_2026-09-17.json", "scan_stage_R19_2026-09-17.json", "scan_PB-R19_2026-09-17.json"):
