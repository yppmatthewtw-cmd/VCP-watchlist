...
def apply_official(r):
    ...
    for k in ("px_0904_intraday", "chg_0904_intraday"):
        r.pop(k, None)
    r["as_of"] = AS_OF if src == "series" else "2026-09-16"   # HEAD fallback = 9/16 close (mid-session 9/17 snapshot)
    r.pop("stale", None)
...
JOBS = [("scan_R26_2026-09-17.json", "scan_R27_2026-09-18.json", "vcp"),
        ("scan_stage_R19_2026-09-17.json", "scan_stage_R20_2026-09-18.json", "stage"),
        ("scan_PB-R19_2026-09-17.json", "scan_PB-R20_2026-09-18.json", "pb")]
