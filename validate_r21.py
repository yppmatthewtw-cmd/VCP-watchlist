#!/usr/bin/env python3
"""Check R21's Yahoo-sourced 2026-09-16 closes against the official close.

R21 published 9/15 from Yahoo alone — the upstream snapshot repo had nothing
newer than a 9/15 mid-session quote. The 9/16 mid-session snapshot's
...
filled_94 = set(FILLED.get("2026-09-16", []))
...
json.dump(out, open("validate_r21_0916.json", "w"), ensure_ascii=False, indent=1)
print(f"R21 9/16 published vs official: n={out['n']} median |Δ|={out['median_pct']}% "
