#!/usr/bin/env python3
"""R15 data build: official 9/4 closes + Yahoo 9/8 closes + 7-item certainty + market-cap tiers (series5: official series through 2026-09-04 merged with Yahoo bars to 2026-09-08).
...
json.dump(cert, open("cert7_2026-09-08.json", "w"), ensure_ascii=False, indent=1)
