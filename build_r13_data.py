#!/usr/bin/env python3
"""R13 data build: official 9/3 closes + 7-item certainty + market-cap tiers (series4 through 2026-09-03).
...
json.dump(cert, open("cert7_2026-09-03.json", "w"), ensure_ascii=False, indent=1)
# any NEW split-like cliff since the last build (9/2 -> 9/3)?
for sym in have:
    fi, cs, vs, ff = SER[sym]
