#!/usr/bin/env python3
"""R20 data build: official 9/14 closes + Yahoo 9/15 closes + 7-item certainty + market-cap tiers (series5: official series through 2026-09-14 merged with Yahoo bars to 2026-09-15).
...
MY = set()
for f in ("scan_R24_2026-09-15.json", "scan_stage_R17_2026-09-15.json", "scan_PB-R17_2026-09-15.json"):
...
json.dump(cert, open("cert7_2026-09-15.json", "w"), ensure_ascii=False, indent=1)
# any NEW split-like cliff since the last build (9/14 -> 9/15)? (Yahoo-aligned series should show none)
for sym in have:
    fi, cs, vs, ff = SER[sym]
