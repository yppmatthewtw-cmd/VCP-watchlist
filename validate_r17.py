#!/usr/bin/env python3
"""Check R17's Yahoo-sourced 2026-09-10 closes against the official close.

R17 published 9/10 from Yahoo alone — the upstream snapshot repo had nothing
newer than a 9/10 mid-session quote. The 9/11 mid-session snapshot's
...
filled_94 = set(FILLED.get("2026-09-10", []))
...
json.dump(out, open("validate_r17_0910.json", "w"), ensure_ascii=False, indent=1)
print(f"R17 9/10 published vs official: n={out['n']} median |Δ|={out['median_pct']}% "
